    ...
    ?>
      ...
      $row = $result->fetch_assoc();
        ?>
            ...
            <p>Due : <?php echo $row['pending_amt'];?></p>
          </div>
      ...
      <form method="POST" action="add-money-db.php" id="cashForm">
        ...
        <div class="row col-xs-8">
          ...
          <div class="col-xs-4 mr-2"><input type="number" name="cash_amount" id="cash_amount" class="amount-input" oninput="checkAmountValidity()"/></div>
         <div class="col-xs-2 mr-2">
        <input type="submit" class="btn btn-success btn-sm add-button" name="add_cash_payment" id="addButton" value="ADD" disabled/></div>
       </div>
      </form>
    </div>
    <div id="cardTab" class="tab-content" style="display:none;">
        <form method="POST" action="add-money-db.php" id="cardForm">
        ...
        <input type="text" name="patient_id" value="<?php echo $patient_id;?>" hidden>
           ...
           <div class="row col-md-8">
            ...
            <div class="row col-md-8">
              ...
              <div class="col-md-4"><input type="text" id="card_amt" name="card_amt"  value="" class="amount-input" oninput="checkAmountValidity()"/></div>
            </div>
            <div class="col-md-5 text-center">
               <input type="submit" name="add_card_payment" class="btn btn-success btn-sm add-button" id="add_card_payment" value="Add" disabled/>
            </div> 
      </form>
    </div>
    <div id="onlineTab" class="tab-content" style="display:none;">
        <form method="POST" action="add-money-db.php" id="onlineForm">
        ...
        <input type="text" name="patient_id" value="<?php echo $patient_id;?>" hidden>
         ...
         <div class="row col-md-8">
            ...
            <div class="col-md-4"><input type="text" name="online_amt" id="online_amt" class="amount-input" oninput="checkAmountValidity()"/></div>
         </div>
         <div class="col-md-5 text-center">
                
    <input type="submit" class="btn btn-success btn-sm add-button" name="add_online_payment" id="add_online_payment"  value="Add" disabled />
         </div>
         
        </form>
    </div>
    <div id="chequeTab" class="tab-content" style="display:none;">
        <form method= "POST" action="add-money-db.php" id="chequeForm">
        ...
        <input type="text" name="patient_id" value="<?php echo $patient_id;?>" hidden>
         ...
         <div class=" row col-md-8">
          ...
          <div class="col-md-4"><input type="text" id="cheque_number" name="cheque_number" class="amount-input" oninput="checkAmountValidity()"></div>
            
          </div>
        <div class="col-md-5 text-center"></div>
        <input type="submit" name="add_cheque_payment" class="btn btn-success btn-sm add-button" id="add_cheque_payment" value="Add" disabled/>
      </form>
    </div>
      <?php
      }
...
<script defer>
  function setupFormValidation(formId) {
    ...
    function checkAmountValidity() {
      var cashAmount = parseFloat(amountInput.value);
      var totalAmount = parseFloat('<?php echo $row['total']; ?>');
      var dueAmount = parseFloat('<?php echo $row['pending_amt']; ?>');

      if (cashAmount > 0 &&  (cashAmount <= dueAmount)) {
  ...
  // Call the setupFormValidation function for each form
  setupFormValidation('cashForm');
  setupFormValidation('cardForm');
  setupFormValidation('onlineForm');
  setupFormValidation('chequeForm');
</script>
