...
<div id="eventDetailsModal" class="modal" >
    <div class="modal-content" style="margin-top: -140px; margin-left: -50px;">
...
<div id="editEventModal" class="modal">
    ...
    <div class="form-group">
        <label for="editPatientFirstName" class="form-heading"><b>First Name:</b></label>
        <input type="text" id="editPatientFirstName" name="editPatientFirstName" class="form-control" placeholder="First Name">
    </div>
    <div class="form-group">
        <label for="editPatientLastName" class="form-heading"><b>Last Name:</b></label>
        <input type="text" id="editPatientLastName" name="editPatientLastName" class="form-control" placeholder="Last Name">
    </div>
...
suggestionsContainer.innerHTML = '';
  ...
  transform: translate(-50%, -50%); */
        ...
        #booking_appoinement_loader_overlay {
            display: none;
            position: fixed;
            top: 0;
            left: 0;
        ...
        @keyframes spin {
            ...
            100% { transform: rotate(360deg); }
              ...
              </form>  <!-- booking appointment form end -->
              <div id="booking_appoinement_loader_overlay"></div>

<div id="booking_appoinement_loader">
    <div class="spinner"></div>
    <div class="loader-message">
        Please wait as booking process is in progress...
    </div>
</div>

<script>
    function submitForm() {
        document.getElementById('booking_appoinement_loader_overlay').style.display = 'block';
        document.getElementById('booking_appoinement_loader').style.display = 'block';
