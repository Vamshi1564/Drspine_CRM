...
.error-message-below {
 ...
 <script>
  ...
  //   // You have a typo here. It should be "document.getElementById", not "docuemnt,gertembyid".
  //   // Also, it's not clear what you are trying to achieve with this line.
  //   document.getElementById('hiddenBranch').value = '<?php echo $branch_name; ?>';

  //   fetchDocotrsAPI(branchName); // Assuming fetchDocotrsAPI is defined elsewhere.
            ...
            customButtons: {
              view4Days: {
                ...
                click: function() {
                  ...
                  calendar.fullCalendar('changeView', 'agendaDay', { duration: { days: 1 } });
                }
              }
            },
            header: {
    ...
    <option value="done">Done</option>
                ...
                <div class="modal-footer">
                    <div class="button-row">
                        ...
                        <button class="btn blue" id="followupBtn">Follow</button>
...
<script>
    ...
    data: {
        branch_name: '<?php echo $branch_name; ?>',
        id: cancelled_by_id,
    ...
    window.location.href = "app_calender.php?branch_name=<?php echo $branch_name; ?>";
});
        ...
        <div class="form-group">
            ...
            <div class="form-group col-sm-12">
                <select class="form-control form-control-sm">
                    <option value="32157">Dr. Dr Jay</option>
...
<div id="editEventModal" class="modal">
    <div class="card">
        ...
        <div class="card-body">
          <form>
        <input type="text" name="patient_edit_id" id="patient_edit_id">
        <input type="text" name="editeventmodal_branch_name" id="editeventmodal_branch_name">
        ...
        <p style="color: blue" id="editeventmodal_patientName"></p>
            ...
            <select id="editDoctorName" class="form-control" style="margin-top:-10px;">
            ...
            <div class="form-group">
                ...
                <div class="row" style="margin-top:-10px;">
                    <div class="col-md-6">
                    <input type="datetime-local" name="editeventmodal_appointment_date_time">   
                    <!-- <input type="datetime-local" id="editAppointmentDate" class="form-control"> -->
                    </div>
