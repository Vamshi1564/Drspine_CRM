...
if(isset($_POST["doctor_submit"])) {
    if(isset($_POST["doctor"])) {
        ...
        $sql = "UPDATE appointments SET doctor = '$doctor' WHERE id = '$id'";
...
if(isset($_POST["purpose_submit"])) {
    if(isset($_POST["purpose"])) {
        ...
        $sql = "UPDATE appointments SET purpose = '$purpose' WHERE id = '$id'";
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo '<script type="text/javascript">
                alert("Error updating purpose: ' . $conn->error . '");
            </script>';
        }
     
}
}
if(isset($_POST["branch_name_submit"])) {
    if(isset($_POST["branch_name"])) {
        $id = $_POST["branch_name_row_id"];
        ...
        // if($branch_name === $_SESSION['branch_name'] || $_SESSION['role'] === 1)
        // {
        $sql = "UPDATE appointments SET branch_name = '$branch_name' WHERE id = '$id'";
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo '<script type="text/javascript">
                alert("Error updating branch_name: ' . $conn->error . '");
            </script>';
        }
    // }
    ...
    // else {
    //     echo '<script type="text/javascript">
    //       alert("Dont Have Permission to Update status");
    //       window.location="appointment_list.php";
    //   </script>';
    //   }
    }
...
<td><?php echo date("H:i", strtotime($row["time_from"])); ?></td>
<td><?php echo date("H:i", strtotime($row["time_to"])); ?></td>
                                                    ...
                                                    <td>
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" class="doctor-form">
        <input type="hidden" value="<?php echo $row['id']; ?>" name="doctor_row_id"/>
        ...
        <br/>
        <button type="submit" name="doctor_submit" class="btn-success"><i class="fa fa-floppy-o" style="color:white;"></i></button>
    </form>
</td>
