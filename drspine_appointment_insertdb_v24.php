...
$sql = "INSERT INTO drspine_appointment (patient_id,status, appointment_type, appointment_date_time, duration_minutes, doctor_name, patient_first_name, patient_middle_name, patient_last_name, patient_profile_picture, contact_no, email_address, gender, date_of_birth, referred_by, refer_patient_type, refer_patient_name, location_city, location_area, patient_address, reason_for_appointment, case_id, medical_history, procedures, groups, blood_group, id_type, id_number, nh_id, other_history, branch_name) 
VALUES ('$patient_id','schedule', '$appointment_type', '$appointment_date_time', '$duration_minutes', '$doctor_name', '$patient_first_name', '$patient_middle_name', '$patient_last_name', '$patient_profile_picture', '$contact_no', '$email_address', '$gender', '$date_of_birth', '$referred_by', '$refer_patient_type', '$refer_patient_name', '$location_city', '$location_area', '$patient_address', '$reason_for_appointment', '$case_id', '$medical_history', '$procedures', '$groups', '$blood_group', '$id_type', '$id_number', '$nh_id', '$other_history', '$branch_name')";
