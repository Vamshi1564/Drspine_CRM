 ...
 <?php include("menu.php");?>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
             ...
             <?php
              $id= $_GET['id'];
                           $sql="select * from manage_packages where id='$id'";
                                $result=$conn->query($sql);
                                if($row = mysqli_fetch_assoc($result)) 
                                {
                        ?>
              <form action="edit_packagedb.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="pack_name" name="pack_name" autocomplete="off" value="<?php echo $row['pack_name']?>" required>
                  </div>
                  <!-- <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select name="center_type" class="form-control" id="center_type" required>
                     <!-- <option value="<?php echo $row['centre_type']?>" selected><?php echo $row['centre_type']?></option>
                    <option  value="healthcare">MJVA healthcare Pvt Ltd</option>
                    <option  value="wellness">MJVA Wellness Pvt Ltd</option>-->
                        <?php
  $centerTypes = array("healthcare", "wellness"); // Add more options as needed
  foreach ($centerTypes as $center) {
    $selected = ($row['centre_type'] == $center) ? 'selected' : '';
  ...
  ?>
                  ...
                  <div class="row">
                   ...
                   <input type="number" min="0" step="any" class="form-control" id="cost" name="cost" value="<?php echo $row['cost']?>" required>
                    </div>
                  <div class="form-group col-md-4" id="in_ex_gst_fld">
                     <label for="in_ex_gst">Incl/Excl GST</label>
                      <select class="form-control" name="in_ex_gst" id="in_ex_gst">
                        <?php
  $gstOptions = array("Exclusive of GST", "Inclusive of GST");
  foreach ($gstOptions as $option) {
    $selected = ($row['in_ex_gst'] == $option) ? 'selected' : '';
  ...
  ?></select>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="number" min="0" step="any" class="form-control" id="gst" name="gst" value="<?php echo $row['GST']?>" required>
                  </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-4">
                    <label for="gst_amt">GST Amount</label>
                    <input type="number" min="0" step="any" class="form-control" id="gst_amt" name="gst_amt" value="<?php echo $row['gst_amt']?>" required>
                  </div>
                    
                  <div class="form-group col-md-4">
                    <label for="net_price">Net Price</label>
                    <input type="number" min="0" step="any" class="form-control" id="net_price" name="net_price" value="<?php echo $row['net_price']?>" required>
                  </div>
                  </div>
                  <div class="row">
                     <div class="form-group col-md-4">
                    <label for="notes">Notes</label>
                    <textarea class="form-control" id="notes" name="notes" value="<?php echo $row['Notes']?>"><?php echo $row['Notes']?></textarea>
                    </div>
                  </div>
