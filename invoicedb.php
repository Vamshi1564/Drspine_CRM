...
// $sub_total = mysqli_real_escape_string($conn,$_POST['sub_total']);
 ...
 // $customer_email=mysqli_real_escape_string($conn,$_POST['customer_email']);
  ...
  $sub_total = isset($_POST['sub_total']) ? mysqli_real_escape_string($conn, $_POST['sub_total']) : "";
...
foreach ($_POST["packages"] as $key => $val)
 {
  ...
  $gstamtval = mysqli_real_escape_string($conn,$_POST['gstamtval'][$key]);
...
$table = array(array($products, $qtyvalue, $priceval,$gstamtval . ' (' . $gstval . '%)', $discount, $total));
...
<script>
        window.location="manage_invoice.php?patient_id=<?php echo $patient_id?>&branch_name=<?php echo $branch_name;?>"; </script>
<?php
            }
