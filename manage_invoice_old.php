...
$sql = "SELECT 
        ...
        LEFT JOIN manage_packages p ON ii.package = p.pack_name where i.patients_id ='$patient_id' ORDER BY i.created_on DESC";
  ...
  <div class="row">
    ...
    <div class="col-md-12 mb-4 pl-0 pr-0" style="border:1px solid gray;" >
      ...
      <!-- <a style="float:right;" data-pdf-path="<?php echo $invoiceData['invoice_data']['invoice']; ?>"><i class="fa fa-print ml-4 p-1"></i></a> -->
       <a href="<?php echo $invoiceData['invoice_data']['invoice'];?>" target="_blank" style="float:right;"><i class="fa fa-print ml-4 p-1"  onclick="openPrintWindow()"></i></a>

                        <script type="text/javascript">
    function openPrintWindow() {
      window.open("<?php echo $invoiceData['invoice_data']['invoice'];?>", "_blank");
        //var printWindow = window.open("<?php echo $invoiceData['invoice_data']['invoice'];?>", "_blank");
...
<?php
      ...
      <table id="example1" class="mt-0 table table-bordered jsgrid-table" style="box-shadow: 1px 2px 4px 0px #8080804f;margin-top: 0px !important;">
        <tr><th width="40%">Item</th><th>Qty</th><th>Price</th><th>GST</th><th>Discount</th><th>Total</th></tr>
