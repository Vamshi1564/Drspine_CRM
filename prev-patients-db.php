...
$sql = "INSERT INTO prev_patients (patient_id, pname, gender, dob, occupation, age, email, date, contact_number, location, city, source, treatment, session_plans) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
if ($stmt->execute()) {
    echo '<script>alert("New record created successfully"); window.location.href = "view-prev-patients.php";</script>';
} else {
