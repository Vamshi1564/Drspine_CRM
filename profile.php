    ...
    <section class="content">
      <div class="container-fluid">
        ...
        if($result->num_rows>0)
        {
             ...
             {
        ?>
              <form action="profiledb.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="pphone" name="pphone" value="<?php echo $row["phone"]?>" >
                  </div>
                  <!-- <div class="form-group">
              ...
              <form method="POST" action="changepwddb.php" >
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="old_pwd" name="old_pwd" placeholder="New Password">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="con_pwd" name="con_pwd" placeholder="Confirm Password">
                  </div>
