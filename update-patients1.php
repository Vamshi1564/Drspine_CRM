...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows === 1) {
        ...
        exit; // You should exit the script to prevent further execution
    }
...
if (isset($_POST['submit'])) {
    ...
    if ($update_result) {
        ...
        echo "Failed to update patient information."; // Handle the case where the update fails
    }
}
?>
...
<form action="update-patients.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="dob" name="dob" value="<?php echo $patient['dob']; ?>" required>
                  </div>
                  <div class="form-group col-md-4">
