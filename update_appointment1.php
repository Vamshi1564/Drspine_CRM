          ...
          <div class="col-md-10">
            ...
            <div class="card card-primary">
              ...
              if (isset($_POST['submit'])) {
                  ...
                  $update_sql = "UPDATE appointments SET name=?, patient_id=?, date=?, time=?, age=?, occupation=?, email=?, no_of_session=?, mobile=?, doctor=?, city=?, issue=?, payment_status=?, gender=? WHERE id=?";
                  $update_stmt = $conn->prepare($update_sql);
                  $update_stmt->bind_param("sssssssiisssssi", $name, $patient_id, $date, $time, $age, $occupation, $email, $no_of_session, $mobile, $doctor, $city, $issue, $payment_status, $gender, $appointment_id);
                  ...
                  if ($update_result) {
                      ...
                      echo '<script>';
                      echo 'setTimeout(function(){ window.location.href = "appointment_list.php"; }, 1000);'; // Redirect after 2 seconds
                      echo '</script>';
                  }
              }
              ?>
              <form action="" method="POST">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="time" name="time" value="<?php echo $patient['time']; ?>" required>
                  </div>
                  <div class="form-group">
