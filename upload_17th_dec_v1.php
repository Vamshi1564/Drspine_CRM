...
if (isset($_FILES['fileToUpload'])) {
    ...
    if ($file['error'] === UPLOAD_ERR_OK) {
       ...
       // Insert file data, metadata, comments, and patient ID into the database
       $sql = "INSERT INTO patient_docs (patient_id, filename, mime_type, file_data, comments)
       VALUES (?, ?, ?, ?, ?)";
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssss", $patient_id, $fileName, $fileType, $fileData, $comments);
$stmt->execute();
$stmt->close();
        
        // Upload success message and redirect
    ...
    // Handle case where no file input field is named 'fileToUpload'
    echo "No file input field found.";
}
