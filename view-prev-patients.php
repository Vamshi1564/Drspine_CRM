  ...
  <div class="content-wrapper" style="width:'fit-content';">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>View Previous Patients</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Previous Patients</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<style>
.treatment-column {
        max-width: 50px; /* You can adjust the width as needed */
        overflow: hidden;
    ...
    <table id="example1" class="table table-bordered jsgrid-table" style="box-shadow: 1px 2px 4px 0px #8080804f;">
        ...
        <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td class="treatment-column"><?php echo $row["treatment"] ?></td>
                    ...
                    <td>
    <div class="btn-group">
    <a class="btn btn-primary" href="view_prev_patient.php?id=<?php echo $row['id'] ?>" title="View">
            <i class="fa fa-eye"></i>
        </a>
        &nbsp;
        <a class="btn btn-info" href="update-prev-patients.php?id=<?php echo $row['id'] ?>" title="Edit">
            <i class="fa fa-pencil"></i>
        </a>
        &nbsp;
        <a class="btn btn-danger" href="del_prev_patients.php?id=<?php echo $row['id'] ?>" title="Delete">
