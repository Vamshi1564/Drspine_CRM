        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="update_single_patient_details.php?patient_id=<?php echo $patient_id; ?>&branch_name=<?php echo $_GET['branch_name']?>" method="post">
                    ...
                    <input type="text" name="patient_first_name" value="<?php echo $patient['patient_first_name']; ?>" class="form-control" required pattern="[A-Za-z\s]+" title="First name should only contain letters and spaces.">
                    
                    <label>Middle Name:</label>
                    <input type="text" name="patient_middle_name" value="<?php echo $patient['patient_middle_name']; ?>" class="form-control" pattern="[A-Za-z\s]+" title="Middle name should only contain letters and spaces.">
                    
                    <label>Last Name:</label>
                    <input type="text" name="patient_last_name" value="<?php echo $patient['patient_last_name']; ?>" class="form-control" required pattern="[A-Za-z\s]+" title="Last name should only contain letters and spaces.">
                    ...
                    <label>Mobile:</label>
                    <input type="text" name="contact_no" value="<?php echo $patient['contact_no']; ?>" class="form-control" required pattern="\d{10}" title="Mobile number should be 10 digits.">
                    
                    <label>Address:</label>
                    <input type="text" name="patient_address" value="<?php echo $patient['patient_address']; ?>" class="form-control">
                    
                    <label>Email:</label>
                    <input type="email" name="email_address" value="<?php echo $patient['email_address']; ?>" class="form-control" required title="Please enter a valid email address.">
