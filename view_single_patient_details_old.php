  ...
  <section class="content">
      ...
      <div class="col-md-3">
                <table class="table" style="height: 58px; margin-left:-230px;">
                    <tr >
                        <td class="text-center text-black" style="font-size: 18px;border:none; letter-spacing: 3px; font-weight:bold; text-transform:uppercase;"><?php echo $patient['patient_first_name']." ". $patient['patient_last_name']; ?></td>
                    </tr>
                </table>
            </div>
    ...
    <p>
        ...
        <span class="data">
            <?php echo date('d/m/Y', strtotime($patient['date_of_birth'])); ?>
                          ...
                          <td> <p><span class="text-bold" >Gender:</span>    &nbsp;<span class="data"><?php echo $patient['gender']; ?></span></p></td>
                    </tr>

                     <tr>
                        <td><p ><span class="text-bold">Mobile: </span>   &nbsp;<span class="data"><?php echo $patient['contact_no']; ?></span></p></td>
                    
                        <td><p><span class="text-bold" >Address: </span>   &nbsp;  <span class="data"><?php echo $patient['patient_address']; ?></span></p></td>
                         
                          <!-- <td> <p ><span class="heading">Occupation: </span><span class="data"><?php echo $patient['occupation']; ?></span></p></td> -->
                    </tr>
                    <tr>
                    <td> <p><span class="text-bold" >Email: </span>   &nbsp;<span class="data"><?php echo $patient['email_address']; ?></span></p></td>
...
if ($_SESSION['role'] == 'admin' || ($_SESSION['role'] == 'fd' && $_SESSION['role'] != 'cc')) {
    if ($_SESSION['branch_name_s'] === $_SESSION['branch_name']) {
        // Your code here
        ?>
        ...
        <!-- <li style="padding:8px;"><a href="add_appointment_old_patient.php"  style="color:black;">Add Appointents</a></li> -->
    </ul>
  ...
  <!-- Edit patient modal Starts -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="update_single_patient_details.php?patient_id=<?php echo $patient_id; ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                  <center><h3>Appointments Table</h3></center>
...
<div class="card-body">
<center><h3>Sessions Table</h3></center>
   <form action="" method="POST" enctype="multipart/form-data">
               ...
               <select class="form-control" id="appointment_number" name="appointment_number">
                   <option value="">Select Appointment Number</option>
                    ...
                    while ($row = $appointmentNumbersResult->fetch_assoc()) {
                        ...
                        echo '<option value="' . $appointmentNumber . '">' . $appointmentNumber . '</option>';
                    }
                  ?>
               </select>
           </div>
    ...
    if (isset($_POST['appointment_number'])) {
        ...
        $result = $conn->query($sql);
    ?>
       <table id="example1" class="table table-bordered jsgrid-table"
          style="box-shadow: 1px 2px 4px 0px #8080804f;">
           <thead>
               <tr>
                   <th>Session</th>
    ...
    if ($date_time) {
        $formatted_datetime = date('d/m/y   h:i A', strtotime($date_time));
        echo $formatted_datetime;
    } else {
        echo 'No Date Provided';
    }
...
<div class="popup" id="popup">
                ...
                <form action="sessionsdb.php" method="POST" enctype="multipart/form-data" style="width:600px;">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="session_no" name="session_no" required>
                        </div>
                    </div>
    ...
    <div class="form-group col-md-12">
        ...
        <script>
           function openPopup(id, appointmentNumber, branchName, doctorName, timeFrom, timeTo ) {
    ...
    document.getElementById("popup_time_from").value = timeFrom;
    document.getElementById("popup_time_to").value = timeTo;
